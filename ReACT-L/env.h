...
public:
  ...
  TFeatureExtractor* fFeatureExtractor;  /* Feature extractor for AB cycles */
  pybind11::object py_get_action_mask;   /* Python function for getting action mask */
  pybind11::object py_store_experience;  /* Python function for storing experiences */
  pybind11::object py_trigger_update;    /* Python function for triggering PPO updates */
